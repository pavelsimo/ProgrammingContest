...
public:
   ...
   vector <string> getFiles( vector <string> s ) {
      int N = sz(s);
      int lo = 0;
      int hi = N - 1;
      while(lo < N - 2) {
...
namespace moj_harness {
   ...
   int run_test_case( int casenum__ ) {
      ...
      case 0: {
         ...
         return verify_case( casenum__, starttime__, vector <string>( expected__, expected__ + ( sizeof expected__ / sizeof(string) ) ), EllysDirectoryListing().getFiles( vector <string>( files, files + ( sizeof files / sizeof(string) ) ) ) );
      }
      case 1: {
