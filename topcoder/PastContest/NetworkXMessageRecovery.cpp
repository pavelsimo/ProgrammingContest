...
namespace moj_harness {
   ...
   int run_test_case( int casenum__ ) {
      ...
      case 0: {
         ...
         return verify_case( casenum__, starttime__, expected__, NetworkXMessageRecovery().recover( vector <string>( messages, messages + ( sizeof messages / sizeof(string) ) ) ) );
      }
      case 1: {
