...
namespace moj_harness {
   ...
   int run_test_case( int casenum__ ) {
      ...
      case 0: {
         int start[]               = {1};
         int finish[]              = {7};
         double expected__         = 8.485281374238571;

         return verify_case( casenum__, starttime__, expected__, MountainRoad().findDistance( vector <int>( start, start + ( sizeof start / sizeof(int) ) ), vector <int>( finish, finish + ( sizeof finish / sizeof(int) ) ) ) );
      }
      case 1: {
         int start[]               = {0,3,4};
         int finish[]              = {5,9,6};
         double expected__         = 12.727922061357857;
      ...
      case 2: {
         ...
         double expected__         = 158.39191898578665;
      ...
      case 3: {
         int start[]               = {-5,-3};
         int finish[]              = {-2,-2};
         double expected__         = 4.242640687119286;
