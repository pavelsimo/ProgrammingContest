...
namespace moj_harness {
   ...
   int run_test_case( int casenum__ ) {
      ...
      case 0: {
         ...
         return verify_case( casenum__, starttime__, expected__, SumOfLuckiness().theSum( A, B ) );
      }
      case 1: {
         int A                     = 40;
         int B                     = 47;
      ...
      case 4: {
         int A                     = 585858585;
         int B                     = 858585858;
         long long expected__      = 287481025LL;
